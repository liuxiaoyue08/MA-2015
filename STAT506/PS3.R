...
map + scale_colour_gradient(low='white', high='grey20',limits=c(0,3))
...
#Comments:The tails are symmetric, more people from different states with cold climate move to and die in California and Florida because of the better climte.
...
#Time cost in microseconds for 100 calling
# Unit: microseconds
...
#          The generic function is about 0.07ms slower than calling one of the class-specific function in this case
###############################################################
#2.b
